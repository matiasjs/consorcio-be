...
export class UsageMetricsController {
  ...
  @ApiResponse({ status: 201, description: 'Usage metric created successfully' })
  create(@Body() createUsageMetricDto: CreateUsageMetricDto, @CurrentUser() user: RequestUser) {
  ...
  getStatsByDateRange(
    ...
    return this.usageMetricsService.getStatsByDateRange(startDate, endDate, user);
  }
  ...
  @ApiResponse({ status: 200, description: 'Usage metric retrieved successfully' })
  ...
  @ApiResponse({ status: 200, description: 'Usage metric deleted successfully' })
