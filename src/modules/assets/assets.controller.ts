...
export class AssetsController {
  ...
  create(@Body() createAssetDto: CreateAssetDto, @CurrentUser() user: RequestUser) {
  ...
  @ApiResponse({ status: 200, description: 'Maintenance plans retrieved successfully' })
  getMaintenancePlans(@Param('id', ParseUUIDPipe) id: string, @CurrentUser() user: RequestUser) {
